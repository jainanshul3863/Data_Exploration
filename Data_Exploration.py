...
matches_won=len(df[(df.Team!='Australia') & (df.Result=='Won')]) #find total matches won
matches_drawn=len(df[(df.Team!='Australia') & (df.Result=='Drawn')]) #find total matches drawn 
matches_lost=len(df[(df.Team!='Australia') & (df.Result=='Lost')]) #find total matches lost
